  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-dark-900 via-dark-800 to-dark-700 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-4 -right-4 w-32 h-32 bg-gradient-purple-blue opacity-20 rounded-full blur-3xl animate-glass-float"></div>
        <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-gradient-purple-blue opacity-10 rounded-full blur-2xl animate-glass-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-primary-500 opacity-5 rounded-full blur-3xl animate-pulse"></div>
      </div>
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 flex flex-col items-center px-4 py-3 text-xs font-medium transition-all duration-300 relative group ${
                  isActive
